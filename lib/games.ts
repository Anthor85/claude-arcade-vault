...
export const GAMES: Game[] = [
  ...
  },
  {
    id: "serpentina",
    title: "SERPENTINA",
    short: "Come fruta y crece sin morderte la cola.",
    long: "Una serpiente de luz recorre una rejilla de 24 por 24 buscando fruta. Cada bocado la alarga un segmento, y cada cinco frutas sube de nivel y aprieta el paso. Tres vidas: chocar con un muro o con la propia cola cuesta una.",
    cat: "ARCADE",
    cover: "cover-snake",
    color: "green",
    best: 7820,
  ...
  },
  {
    ...
    long: "Tu nave triangular flota en vacío absoluto. Dispara y rota para partir cada asteroide en dos fragmentos más pequeños y veloces. Recoge el disparo triple y el escudo antes de que se desvanezcan.",
    cat: "SHOOTER",
